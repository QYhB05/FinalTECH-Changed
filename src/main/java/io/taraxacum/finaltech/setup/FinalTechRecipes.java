...
public final class FinalTechRecipes {
    ...
    public static final ItemStack[] MATRIX_OPERATION_ACCELERATOR = new ItemStack[]{
            ...
            ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 32), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 32),
            FinalTechItemStacks.ENERGY_CARD_T, ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), FinalTechItemStacks.ENERGY_CARD_T,
            FinalTechItemStacks.ENERGY_CARD_T, ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), FinalTechItemStacks.ENERGY_CARD_T,
            ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 32), FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 32),
            FinalTechItemStacks.BOX, ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 32), FinalTechItemStacks.ENERGY_CARD_T, FinalTechItemStacks.ENERGY_CARD_T, ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 32), FinalTechItemStacks.BOX
    };
