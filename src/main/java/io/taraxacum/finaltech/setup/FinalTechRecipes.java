...
public final class FinalTechRecipes {
    ...
    public static final ItemStack[] MATRIX_OPERATION_ACCELERATOR = new ItemStack[]{
            ...
            ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 1), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 1),
            FinalTechItemStacks.ENERGY_CARD_B, ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), FinalTechItemStacks.ENERGY_CARD_B,
            FinalTechItemStacks.ENERGY_CARD_B, ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), FinalTechItemStacks.ENERGY_CARD_B,
            ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 1), FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.OVERLOADED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ENERGIZED_OPERATION_ACCELERATOR, 16), ItemStackUtil.cloneItem(FinalTechItemStacks.ANNULAR, 1),
